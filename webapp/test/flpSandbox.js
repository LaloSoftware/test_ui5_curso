		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Unit tests",
									"targetURL": "#nstestpractice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nstestpractice-display": {
								"semanticObject": "nstestpractice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.testpractice",
									"url": sap.ui.require.toUrl("ns/testpractice")
								}
							}
						}
					}
